    ...
    const htmlContent = `
      <html>
        ...
        <body onload="window.print()">
          ...
          <div class="row"><div class="label">Vendor Name:</div><div class="value">${data.vendor_name}</div></div>
          ...
          ${data.status === 'approved' ? `
            ...
            <div class="row"><div class="label">Auth Method:</div><div class="value">Out-of-band Biometric (WebAuthn)</div></div>
            <div class="hash-box">
